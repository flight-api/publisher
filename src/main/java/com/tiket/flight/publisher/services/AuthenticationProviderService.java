package com.tiket.flight.publisher.services;
...
import com.tiket.flight.publisher.models.SessionUser;
...
public class AuthenticationProviderService implements org.springframework.security.authentication.AuthenticationProvider {
    ...
    public AuthenticationProviderService(RedisService service) {
